...
namespace Revenue_Forecast
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IClientRevenueService, ClientRevenueService>();
            services.AddTransient<IClientRevenueAuditService, ClientRevenueAuditService>();
